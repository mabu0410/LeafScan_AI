...
const PRIVACY_SECTIONS = ['dataCollection', 'dataUse', 'security', 'sharing', 'contact'];
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {PRIVACY_SECTIONS.map((section) => (
          <View key={section}>
            <Text style={styles.sectionTitle}>{t(`legal.privacy.sections.${section}.title`)}</Text>
            <Text style={styles.body}>{t(`legal.privacy.sections.${section}.body`)}</Text>
          </View>
        ))}
      </ScrollView>
    </View>
